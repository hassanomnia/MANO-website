...
<%
    float _total_price = 0;
    boolean productFlag = true;
    boolean acceptOrder = false;
    Product pro = null;
    int historyProductArray[];
    int historyQuantityArray[];
    ...
    String firstVist = (String) sessionParameters.getAttribute("button");
    sessionParameters.setAttribute("button", "true");
...
//    listOfPruducts= (ArrayList<Product>)sessionParameters.getAttribute("product");
...
<%                  //String checkboxvalue = request.getParameter("ship_to_different_address");
    ...
    String address1 = request.getParameter("billing_address_2");
    String twon = request.getParameter("billing_city");
    ...
    sessionParameters.setAttribute("name1", firstName);
    sessionParameters.setAttribute("name2", lastName);
    sessionParameters.setAttribute("address", address);
    sessionParameters.setAttribute("address1", address1);
    sessionParameters.setAttribute("address2", twon);
    sessionParameters.setAttribute("post", postCode);
    sessionParameters.setAttribute("email", email);
    sessionParameters.setAttribute("phone", phone);

    String field1 = (String) sessionParameters.getAttribute("name1");
    String field2 = (String) sessionParameters.getAttribute("name2");
    String field3 = (String) sessionParameters.getAttribute("address");
    String field4 = (String) sessionParameters.getAttribute("address1");
    String field5 = (String) sessionParameters.getAttribute("address2");
    String field6 = (String) sessionParameters.getAttribute("post");
    String field7 = (String) sessionParameters.getAttribute("email");
    String field8 = (String) sessionParameters.getAttribute("phone");
                                ...
                                <div class="col-1">
                                    <div class="woocommerce-billing-fields">
                                        ...
                                        <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                            <label class="" for="billing_first_name1">First Name <abbr title="required" class="required">*</abbr>
                                            </label>
                                            <input type="text"  placeholder="" id="billing_first_name1" name="billing_first_name" <%if (field1 != null) {%>value="<%=field1%>"<%}%> class="input-text ">
                                        </p>

                                        <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                            <label class="" for="billing_last_name">Last Name <abbr title="required" class="required">*</abbr>
                                            </label>
                                            <input type="text" <%if (field2 != null) {%>value="<%= field2%>"<%}%> placeholder="" id="billing_last_name" name="billing_last_name" class="input-text ">
                                        </p>
                                        <div class="clear"></div>
                                        ...
                                        <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <input type="text" <%if (field3 != null) {%>value="<%= field3%>"<%}%> placeholder="Street address" id="billing_address_1" name="billing_address_1" class="input-text ">
                                        </p>

                                        <p id="billing_address_2_field" class="form-row form-row-wide address-field">
                                            <input type="text" <%if (field4 != null) {%>value="<%= field4%>"<%}%> placeholder="Apartment, suite, unit etc. (optional)" id="billing_address_2" name="billing_address_2" class="input-text ">
                                        </p>

                                        <p id="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                            <label class="" for="billing_city">Town / City <abbr title="required" class="required">*</abbr>
                                            </label>
                                            <input type="text" <%if (field5 != null) {%>value="<%= field5%>"<%}%> placeholder="Town / City" id="billing_city" name="billing_city" class="input-text ">
                                        </p>
                                        ...
                                        <p id="billing_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                            ...
                                            <input type="text" <%if (field6 != null) {%>value="<%= field6%>"<%}%> placeholder="Postcode / Zip" id="billing_postcode" name="billing_postcode" class="input-text ">
                                        </p>
                                        ...
                                        <p id="billing_email_field" class="form-row form-row-first validate-required validate-email">
                                            ...
                                            <input type="text" <%if (field7 != null) {%>value="<%= field7%>"<%}%> placeholder="" id="billing_email" name="billing_email" class="input-text ">
                                        </p>

                                        <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                            <label class="" for="billing_phone">Phone <abbr title="required" class="required">*</abbr>
                                            </label>
                                            <input type="text" <%if (field8 != null) {%>value="<%= field8%>"<%}%> placeholder="" id="billing_phone" name="billing_phone" class="input-text ">
                                        </p>
                                        <div class="clear"></div>
                                    </div>
                                </div>
                            ...
                            <div id="order_review" style="position: relative;">
                                <table class="shop_table">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="order-total">
                                            <th>Order Total</th>
                                            <td><strong><span class="amount"><%=_total_price%>$</span></strong> </td>
                                        </tr>
                                ...
                                <div id="payment">
                                    ...
                                    <div class="form-row place-order">
                                        <%
                                    if (firstName != null && lastName != null && address != null && address1 != null && twon != null && postCode != null && email != null && phone != null) {
                                        if (firstName == "" || lastName == "" || address == "" || address1 == "" || twon == "" || postCode == "" || email == "" || phone == "") {   %>
                                        <p style="color: red; text-align: center">Please fill all requirements fields</p>
                                        <input type="submit"  value="Place order" id="place_order" name="submit" class="button alt"><%
                                            }
                                        } else {
                                        %>
                                        <%
                                        ...
                                        <p style="color: red; text-align: center">You need to log in before place your order</p>
                                        <input type="submit"  value="Place order" id="place_order" name="submit" class="button alt">
                                        <%} else {
                                            historyProductArray = new int[listOfProducts.size()];
                                            historyQuantityArray = new int[listOfProducts.size()];
                                            for (int i = 0; i < listOfProducts.size(); i++) {
                                                pro = listOfProducts.get(i);
                                                historyProductArray[i] = pro.getID();
                                                historyQuantityArray[i] = pro.getQuantity();
                                                float product_price = DataBaseManagement.checkProductQuantity(c, pro.getID(), pro.getQuantity());
                                                if (product_price == 0) {
                                                    String productName = DataBaseManagement.getProductName(c, pro.getID());
                                                    productFlag = false;
                                        %>                                          
                                        <p style="color: red; text-align: center">Sorry, This quantity of <%=productName%> is not currently available</p>
                                        <input type="submit"  value="Place order" id="place_order" name="submit" class="button alt">
                                        <%}
                                            }
                                            if (productFlag) {
                                                System.out.println(_total_price);
                                                String check = DataBaseManagement.checkCreditInfo(c, name, _total_price);
                                                if (check.equals("false")) {%>
                                        <p style="color: red; text-align: center">Sorry, Your credit has no enough money</p>
                                        <input type="submit"  value="Place order" id="place_order" name="submit" class="button alt">
                                        <%
                                        } else {
                                            if (_total_price != 0 && !acceptOrder) {
                                                int updateRowsProduct = DataBaseManagement.updateProductAterSale(c, pro.getID(), pro.getQuantity());
                                                int updateRowsCustomer = DataBaseManagement.updateCustomerAterSale(c, name, _total_price);
                                                for (int i = 0; i < historyProductArray.length; i++) {
                                                    DataBaseManagement.insertProductHistory(c, name, historyProductArray[i]);
                                    ...
                                    } else {%><p style="color: #5a88ca; text-align: center">Your cart is empty </p>
                                        <input type="submit"  value="Place order" id="place_order" name="submit" class="button alt"><%}
                                                    }
                                                }
                                            }
                                        } else {%>  <input type="submit"  value="Place order" id="place_order" name="submit" class="button alt"><%}
                                                            }
                                        %>
