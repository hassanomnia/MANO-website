<%-- 
    Document   : Mobiles2.jsp
    Created on : Mar 26, 2021, 7:14:54 AM
    Author     : Nihal
--%>
...
<%
    ...
    if (request.getParameter("add-to-cart") != null) {
        ...
        response.sendRedirect("Mobiles2?action=mobile.jsp");
    }
%>
...
<div class="single-product-area">
    ...
    <div class="container">
        <div class="row">
            <jsp:scriptlet>
                    rs = DataBaseManagement.selectMobiles(c, 9, 16);
                    while (rs.next()) {
            ...
            <div class="col-md-3 col-sm-6">
                <div class="single-shop-product">
                    ...
                    <div class="product-option-shop">
                        <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="Mobiles2.jsp?add-to-cart=<%=id%>&action=mobile">Add to cart</a>
                    </div>                       
                </div>
            </div>
