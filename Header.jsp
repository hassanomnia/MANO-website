        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <%if(logInFlag != null && logInFlag.equals("true")){log="out";}else{log="in";}%>
                    ...
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            <li class="dropdown dropdown-small">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#"><span class="key"></span><img src=<%=url%> style="width:30px;height:30px;"><span class="value"><%if(logInFlag != null && logInFlag.equals("true")){%><%=username%><%}%></span></a>
