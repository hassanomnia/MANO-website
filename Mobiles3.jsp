<%-- 
    Document   : Mobiles3
    Created on : Mar 26, 2021, 7:19:39 AM
    Author     : Nihal
--%>
...
<%
    ...
    if (request.getParameter("add-to-cart") != null) {
        ...
        response.sendRedirect("Mobiles3.jsp?action=mobile");
    }
%>
...
<div class="single-product-area">
    ...
    <div class="container">
        <div class="row">
            <jsp:scriptlet>
                    rs = DataBaseManagement.selectMobiles(c, 17, 19);
                    while (rs.next()) {
            ...
            <div class="col-md-3 col-sm-6">
                <div class="single-shop-product">
                    ...
                    <div class="product-option-shop">
                        <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="Mobiles3.jsp?add-to-cart=<%=id%>&action=mobile">Add to cart</a>
                    </div>                       
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="product-pagination text-center">
                    <nav>
                        <ul class="pagination">
                            <li>
                                <a href="Mobiles2.jsp?action=mobile" aria-label="Previous">
                            ...
                            <li>
                                <a href="Mobiles3.jsp?action=mobile" aria-label="Next">
